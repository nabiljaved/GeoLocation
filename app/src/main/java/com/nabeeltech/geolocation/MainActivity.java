...
public class MainActivity extends AppCompatActivity {
    ...
    Button buttonGetLocation, buttonStopLocation, gotoMap, gottoMapView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gottoMapView = findViewById(R.id.mapview);

        textViewLatitude = (TextView)findViewById(R.id.textViewLatitude);
        textViewLongitude = (TextView)findViewById(R.id.textViewLongitude);

        gottoMapView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if(lat!=null){
                    ...
                    mBundle.putDouble("latitute", lat);
                    mBundle.putDouble("longitute", lng);
                    intent.putExtras(mBundle);
                    startActivity(intent);
                }else{
                    Toast.makeText(MainActivity.this, "please fetch location first", Toast.LENGTH_SHORT).show();
                }
